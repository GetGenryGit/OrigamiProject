...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 730453815, ; hash 0x2b89d737, from name: aot-Origami.WebComponents
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 764612908, ; hash 0x2d93112c, from name: aot-Origami.WebComponents.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Origami.WebComponents.dll.so
		ptr null; void* handle (0x0)
	}, ; 91
	...
	%struct.DSOCacheEntry {
		i64 887229348, ; hash 0x34e20ba4, from name: libaot-Origami.WebComponents.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Origami.WebComponents.dll.so
		ptr null; void* handle (0x0)
	}, ; 114
	...
	%struct.DSOCacheEntry {
		i64 1414632214, ; hash 0x54519316, from name: Origami.WebComponents
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Origami.WebComponents.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 1549688985, ; hash 0x5c5e6099, from name: aot-Origami.App
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1630854955, ; hash 0x6134df2b, from name: aot-Origami.App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Origami.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 207
	...
	%struct.DSOCacheEntry {
		i64 1893541549, ; hash 0x70dd26ad, from name: Origami.App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Origami.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 243
	...
	%struct.DSOCacheEntry {
		i64 1956639342, ; hash 0x749ff26e, from name: libaot-Origami.WebComponents
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Origami.WebComponents.dll.so
		ptr null; void* handle (0x0)
	}, ; 256
	...
	%struct.DSOCacheEntry {
		i64 2151282119, ; hash 0x8039f5c7, from name: Origami.App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Origami.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 2581005442, ; hash 0x99d70482, from name: libaot-Origami.App
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Origami.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 4287683678, ; hash 0xff90dc5e, from name: libaot-Origami.App.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Origami.App.dll.so
		ptr null; void* handle (0x0)
	}, ; 576
	...
	%struct.DSOCacheEntry {
		i64 4289849042, ; hash 0xffb1e6d2, from name: Origami.WebComponents.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Origami.WebComponents.dll.so
		ptr null; void* handle (0x0)
	}, ; 578
